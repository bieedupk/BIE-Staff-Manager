  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col gap-4">
        {/* Present Row */}
        <div className="opacity-0" style={{ animation: "slide-in-settle 1000ms ease-out forwards 0ms" }}>
        ...
        {/* Absent Row */}
        <div className="opacity-0" style={{ animation: "slide-in-settle 1000ms ease-out forwards 150ms" }}>
          <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-3">
            <div className="relative h-2 w-full overflow-hidden rounded bg-red-100 flex-1">
              <div
                ...
                style={{ width: `${absentPct}%`, animationFillMode: "both", animationDelay: "150ms" }}
              />
            </div>
        ...
        {/* Late Row */}
        <div className="opacity-0" style={{ animation: "slide-in-settle 1000ms ease-out forwards 300ms" }}>
          <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-3">
            <div className="relative h-2 w-full overflow-hidden rounded bg-amber-100 flex-1">
              <div
                ...
                style={{ width: `${latePct}%`, animationFillMode: "both", animationDelay: "300ms" }}
              />
            </div>
        ...
        {/* Half Day Row */}
        <div className="opacity-0" style={{ animation: "slide-in-settle 1000ms ease-out forwards 450ms" }}>
          <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-3">
            <div className="relative h-2 w-full overflow-hidden rounded bg-orange-100 flex-1">
              <div
                ...
                style={{ width: `${halfDayPct}%`, animationFillMode: "both", animationDelay: "450ms" }}
              />
            </div>
